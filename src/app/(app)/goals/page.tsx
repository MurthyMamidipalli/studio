        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Define what you want to achieve this week.</DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-primary/5 border-none shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Based on completed goals</p>
          </CardContent>
        </Card>
        <Card className="bg-accent/5 border-none shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Current pursuits</p>
          </CardContent>
        </Card>
        <Card className="bg-purple-500/5 border-none shadow-sm">
          ...
          <CardContent>
            <p className="text-3xl font-headline font-bold">{category}</p>
        ...
        {isLoading ? (
          ...
          <div className="col-span-full text-center py-20 bg-muted/20 rounded-2xl border-2 border-dashed">
            ...
            <p className="text-muted-foreground max-w-xs mx-auto mt-2">
              You haven't set any fitness goals yet. Click the button above to start your journey!
            </p>
          </div>
        )}
      </div>
