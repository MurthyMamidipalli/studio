  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-500 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard title="Weekly Goals" value={`${processedData.metrics.weeklyWorkouts}/5`} unit="sets" icon={Calendar} color="text-purple-500" />
      </div>
      ...
      <CardContent className="p-4 md:p-6">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-lg md:text-2xl font-headline font-bold">{value}</span>
            <span className="text-[10px] md:text-sm text-muted-foreground">{unit}</span>
          </div>
        </div>
      </CardContent>
    </Card>
